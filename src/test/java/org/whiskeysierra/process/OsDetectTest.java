...
public final class OsDetectTest {
    ...
    public OsDetectTest(String name, String version, String arch, String pathSeparator, String fileSeparator,
        Set<Family> families) {
    ...
    public static Collection<Object[]> getExamples() {
        return Arrays.asList(new Object[][]{
            ...
            // file separator '/' is not entirely correct, but it supports unix style paths, so
            // we stick with it for now
    ...
    public void testFromProperties() {
        ...
        properties.setProperty("file.separator", fileSeparator);
